...
<div class="callout">
  ...
  <p><a href="mailto:mira.maty@web.de">mira.maty@web.de</a></p>
</div>
...
<p>Use the same address and say in the subject line that it is a security report.
Please include enough detail to reproduce the issue. How the app handles data, and
what it deliberately does not do, is set out in the
<a href="../security-privacy/">security and privacy statement</a>.</p>
